...
Статическая доска задач и полный отчёт по аудиту сайта «Сладкий Град». Доска доступна только по ссылке с токеном в части URL после `#`; токен не передаётся GitHub Pages или Supabase в HTTP-запросах.
